...
-- ============================================
-- 4d. Guest Trial Usage Table
-- ============================================
-- Purpose: Count anonymous landing-page trial completions without storing
-- chat content or personal data.
...
CREATE INDEX IF NOT EXISTS idx_guest_trial_usage_expires_at ON public.guest_trial_usage(expires_at);
